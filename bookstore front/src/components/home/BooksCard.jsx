...
import {PiBookOpenTextLigth} from 'react-icons/pi';
  ...
  return (
    <div className='grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4'>
      {books.map((item)=> {
        ...
        >
          <h2 className='absolute top-1 right-2 rounded-lg px-4 py-2 m-4 relative hover:shadow-xl'>
            {item.publishYear}
          </h2>
          ...
          <div className="flex justify-betweem itens-center gap-x-2 mt-4 p-4">
